...
<header>
		...
		<div class="row">
			<div class="col-auto col-sm-5">
				<a class="navbar-brand me-0 px-3" href="#"><img src="/resources/user/image/h1_logo.png"></a>
			</div>
		...
		<div class="nav justify-content-center"">
			<ul class="nav">
				<li class="nav-item"><a class="nav-link" style="padding-left:50px; padding-right:50px;" href="#">오특</a></li>
				<li class="nav-item"><a class="nav-link" style="padding-left:50px; padding-right:50px;" href="#">신상</a></li>
				<li class="nav-item"><a class="nav-link" style="padding-left:50px; padding-right:50px;" href="#">랭킹</a></li>
				<li class="nav-item"><a class="nav-link" style="padding-left:50px; padding-right:50px;" href="#">프리미엄관</a></li>
				<li class="nav-item"><a class="nav-link" style="padding-left:50px; padding-right:50px;" href="#">기획전</a></li>
				<li class="nav-item"><a class="nav-link" style="padding-left:50px; padding-right:50px;" href="#">세일</a></li>
				<li class="nav-item"><a class="nav-link" style="padding-left:50px; padding-right:50px;" href="#">기프트카드</a></li>
				<li class="nav-item"><a class="nav-link" style="padding-left:50px; padding-right:50px;" href="#">멤버십/쿠폰</a></li>
				<li class="nav-item"><a class="nav-link" style="padding-left:50px; padding-right:50px;" href="#">이벤트</a></li>
			</ul>
		</div>
				...
				<div class="position-sticky pt-3">
					...
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link" href="#"> 메이크업 /
								네일 </a></li>
						<li class="nav-item"><a class="nav-link" href="#"> 바디케어 </a></li>
						<li class="nav-item"><a class="nav-link" href="#"> 헤어케어 </a></li>
						<li class="nav-item"><a class="nav-link" href="#"> 향수 /
								디퓨저 </a></li>
						<li class="nav-item"><a class="nav-link" href="#"> 미용소품 </a></li>
						<li class="nav-item"><a class="nav-link" href="#"> 남성 </a></li>
						<li class="nav-item"><a class="nav-link" href="#"> 건강 /
								위생용품 </a></li>
						<li class="nav-item"><a class="nav-link" href="#"> 건강식품 </a></li>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="input-group">
								<a href="#">
									<div class="card" style="width: 18rem;">
										<img src="/resources/user/image/manyo1.jpg" class="card-img-top"
											alt="...">
										<div class="card-body">
											<p class="card-text">
									...
									<div class="card" style="width: 18rem;">
										<img src="/resources/user/image/manyo2.jpg" class="card-img-top"
											alt="...">
										<div class="card-body">
											<p class="card-text">
